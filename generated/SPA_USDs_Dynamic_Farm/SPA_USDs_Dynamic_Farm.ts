...
export class SPA_USDs_Dynamic_Farm__depositsResult {
  value0: boolean;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class SPA_USDs_Dynamic_Farm__rewardFundsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class SPA_USDs_Dynamic_Farm__subscriptionsResult {
  value0: i32;
  value1: BigInt;
  value2: BigInt;
...
export class SPA_USDs_Dynamic_Farm extends ethereum.SmartContract {
  static bind(address: Address): SPA_USDs_Dynamic_Farm {
    return new SPA_USDs_Dynamic_Farm("SPA_USDs_Dynamic_Farm", address);
  }
  ...
  deposits(
    param0: Address,
    param1: BigInt
  ): SPA_USDs_Dynamic_Farm__depositsResult {
    let result = super.call(
      "deposits",
    ...
    return new SPA_USDs_Dynamic_Farm__depositsResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_deposits(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<SPA_USDs_Dynamic_Farm__depositsResult> {
    let result = super.tryCall(
      "deposits",
      "deposits(address,uint256):(bool,uint256,uint256,uint256,uint256,uint256)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new SPA_USDs_Dynamic_Farm__depositsResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  rewardFunds(param0: BigInt): SPA_USDs_Dynamic_Farm__rewardFundsResult {
    let result = super.call(
      "rewardFunds",
    ...
    return new SPA_USDs_Dynamic_Farm__rewardFundsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_rewardFunds(
    param0: BigInt
  ): ethereum.CallResult<SPA_USDs_Dynamic_Farm__rewardFundsResult> {
    let result = super.tryCall(
      "rewardFunds",
      "rewardFunds(uint256):(uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new SPA_USDs_Dynamic_Farm__rewardFundsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  subscriptions(
    param0: BigInt,
    param1: BigInt
  ): SPA_USDs_Dynamic_Farm__subscriptionsResult {
    let result = super.call(
      "subscriptions",
    ...
    return new SPA_USDs_Dynamic_Farm__subscriptionsResult(
      result[0].toI32(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_subscriptions(
    param0: BigInt,
    param1: BigInt
  ): ethereum.CallResult<SPA_USDs_Dynamic_Farm__subscriptionsResult> {
    let result = super.tryCall(
      "subscriptions",
      "subscriptions(uint256,uint256):(uint8,uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new SPA_USDs_Dynamic_Farm__subscriptionsResult(
        value[0].toI32(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
